...
if __name__ == '__main__':
    ...
    #          ["torchrun", "--nproc_per_node=2", os.path.join(BASE_DIR, "train_ddp_fracture_per_agegroup_convnextv2_0731.py")])
    run_step("Step 3: Training all AP/Lat × AgeGroup models...",
             ["torchrun", "--nproc_per_node=2", os.path.join(BASE_DIR, "train_ddp_fracture_per_agegroup_convnextv2_0811.py")])

    # Step 4: Grad-CAM + 결과 저장
    # run_step("Step 4: Generating Grad-CAM visualizations...",
    #          ["python", os.path.join(BASE_DIR, "Generate_Gradcam_ConvNeXtV2_gradcampp_0804.py")])
    run_step("Step 4: Generating Grad-CAM visualizations...",
             ["python", os.path.join(BASE_DIR, "Generate_Gradcam_ConvNeXtV2_ALL_0813.py")])
