...
def main():
    ...
    ap.add_argument("--model_root", required=True, default="/mnt/data/KimJG/SwinT/mediaiOA_swinT_cls-main_original/20250623_Single/WristFX_0730/classification",help="classification 디렉토리 (그 안에 Model_Fold/ 존재)")
    ...
    fold_dir = Path(args.model_root) / "Model_Fold_1110"
